...
@section('content_header')
    ...
    <h1>Permissões do perfil {{$profile->name}} <a href="{{ route('profiles.permissions.available', $profile->id) }}" class="btn btn-success"> <i class="fas fa-plus-square"></i> NOVA PERMISSÃO </a> </h1>
@stop

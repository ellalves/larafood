...
return [
    ...
    'attributes'           => [
        'address.street'        => 'Rua e número',
        'address.post_code'     => 'Código Postal',
        'address.city'          => 'Cidade',
        'address.state'         => 'Estado',
        'address.country'       => 'País',
        'address.notas'         => 'complemento',
        'address.lat'           => 'latitude',
        'address.lng'           => 'longitude',
        'address.route'         => 'Rota',
        'address.street_number' => 'Número da rua',
        'address.street_extra'  => 'Bairro',
        ...
        'lat'                   => 'latitude',
        'lng'                   => 'longitude',
        'stripe_id'             => 'Identificador do plano no stripe',
        'company'               => 'empresa',
        'tenant'                => 'empresa',
        'company_token'         => 'O código da empresa',
        'products'              => 'produtos',
        'products.*.identify'   => 'identificador do produto',
        'products.*.qty'        => 'quantidade do produto',
        'document'              => 'Documento',
        'address'               => 'endereço',
        'age'                   => 'idade',
        'body'                  => 'conteúdo',
